...
//肘关节100度
double ElbowHundredAngle[10][7];
double ElbowSpeed2Data[10][7];		//肘关节2度/秒
double ElbowSpeed4Data[10][7];		//肘关节4度/秒
double ElbowSpeed6Data[10][7];		//肘关节6度/秒
double WristSixtyAngle[10][7];		//腕关节60度
double HandHold[10][7];				//手抓取
double Move[10][7];
...
HRESULT CRobotArmMain::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
	...
	if (m_PlcToCpp.PlcStarted)	//PLC控制整体启动
	{
		...
		{
		case 0:	//电机初始化
			ShoulderInitStart = true;
			if ((m_PlcToCpp.ShoudlerInitFinish) && (m_PlcToCpp.LevelShiftExtEnabled) && (m_PlcToCpp.RotateExtEnabled))
			{
		...
		case 4:	//开始执行动作各个动作。暂时每个动作一段代码。TODO：写一个适用于所有动作的代码。//整体动作
			if (PositionNum < PositionSize)
			{
				...
				case 1:
					...
					{
						//肩关节
						double SetShoulderLevelShiftAngle = ShoulderLevelShiftPolynomial.pos(MoveTimer);
						double SetShoulderRotateAngle = ShoulderRotatePolynomial.pos(MoveTimer);
...
//void CRobotArmMain::PolyFun(double AngleData[][7])
//{
//	if (AngleData != NULL)
//	{
//		//肩关节平移
//		ShoulderLevelShiftPolynomial.plan3rdProfileT(
//			AngleData[PositionNum][4],
//			AngleData[PositionNum + 1][3],
//			AngleData[PositionNum][0],
//			AngleData[PositionNum + 1][0],
//			0, 0);
//		//肩关节旋转
//		ShoulderRotatePolynomial.plan3rdProfileT(
//			AngleData[PositionNum][4],
//			AngleData[PositionNum + 1][3],
//			AngleData[PositionNum][1],
//			AngleData[PositionNum + 1][1],
//			0, 0);
//		//肘关节平移
//		ElbowPolynomial.plan3rdProfileT(
//			AngleData[PositionNum][4],
//			AngleData[PositionNum + 1][3],
//			AngleData[PositionNum][2],
//			AngleData[PositionNum + 1][2],
//			0, 0);
//		//腕关节平移
//		WristPolynomial.plan3rdProfileT(
//			AngleData[PositionNum][4],
//			AngleData[PositionNum + 1][3],
//			AngleData[PositionNum][3],
//			AngleData[PositionNum + 1][3],
//			0, 0);
//	}
//	else
